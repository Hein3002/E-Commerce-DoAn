...
import Insert_Update from "../../component/modal/brand/insert_update";
import Delete from "../../component/modal/brand/delete";
import { apiGetAll } from "../../services/admin/brand.services";
    ...
    const columns: ColumnsType<BrandType> = [
        {
            ...
            width: "115px",
            render: (_, record) => {
                return <Image src={('images/brand/' + record.image)} />
            }
        },
        {
            title: "Name",
