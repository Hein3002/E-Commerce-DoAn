...
import Insert_Update from "../../component/modal/category/insert_update";
import Delete from "../../component/modal/category/delete";
import { apiGetAll } from "../../services/admin/category.services";
    ...
    const columns: ColumnsType<CategoryType> = [
        {
            ...
            width: "115px",
            render: (_, record) => {
                return <Image src={('images/Category/' + record.image)} />
            }
        },
        {
            title: "Name",
