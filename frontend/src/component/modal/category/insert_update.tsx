...
import { apiCreate, apiGetByID, apiUpdate } from "../../../services/admin/category.services";
...
const Insert_Update = (props: any) => {
  ...
  const [image, setImage] = useState<File | string | null>(null); // State to hold the image file
    ...
    <>
      ...
      >
        ...
        >
          ...
          {image && (
              typeof image === 'string' ? (
                <Image style={{ height: '200px', marginTop: '10px' }} src={`images/category/${image}`} />
              ) : (
